...
class TaxDB():
    ...
    def search_from_id(self, taxID):
        ...
        taxID_entry = TaxID_entry(tax_path, scientific_names_path, common_names_path, phylo_names_path,
                                  genbank_common_names_path)
        return taxID_entry
...
class TaxidLineage:
    ...
    def get_ranks(self, taxid,  ranks=['superkingdom', 'kingdom', 'phylum', 'class', 'order', 'family', 'genus', 'species']):
